...
internal val spotListUiStateRestaurantMock = SpotListUiStateV2.Success(
    ...
    spotList = listOf(
        com.acon.acon.core.model.model.spot.Spot(
            id = 9L,
            name = "부대찌개대사관",
            ...
            tags = listOf(
                com.acon.acon.core.model.type.TagType.TOP_1,
                com.acon.acon.core.model.type.TagType.NEW,
                com.acon.acon.core.model.type.TagType.LOCAL
            ),
        ...
        com.acon.acon.core.model.model.spot.Spot(
            ...
            tags = listOf(
                com.acon.acon.core.model.type.TagType.TOP_2,
                com.acon.acon.core.model.type.TagType.LOCAL
            ),
            closingTime = "23:00".toLocalTime()!!,
            isOpen = true,
        ...
        com.acon.acon.core.model.model.spot.Spot(
            ...
            tags = listOf(com.acon.acon.core.model.type.TagType.TOP_3),
        ...
        com.acon.acon.core.model.model.spot.Spot(
            ...
            latitude = 37.572793,
            longitude = 126.976986,
            tags = listOf(com.acon.acon.core.model.type.TagType.TOP_4),
        ...
        com.acon.acon.core.model.model.spot.Spot(
            ...
            latitude = 37.572793,
            longitude = 126.976986,
            tags = listOf(com.acon.acon.core.model.type.TagType.TOP_5),
            closingTime = "22:00".toLocalTime()!!,
            isOpen = true,
            nextOpening = "10:00".toLocalTime()!!
        ),
        com.acon.acon.core.model.model.spot.Spot(
            ...
            latitude = 37.572793,
            longitude = 126.976986,
            tags = listOf(com.acon.acon.core.model.type.TagType.NEW),
            closingTime = "22:00".toLocalTime()!!,
            isOpen = true,
            nextOpening = "10:00".toLocalTime()!!
        ),
    ...
    selectedSpotType = com.acon.acon.core.model.type.SpotType.RESTAURANT,
...
internal val spotListUiStateCafeMock = SpotListUiStateV2.Success(
    ...
    spotList = listOf(
        ...
        com.acon.acon.core.model.model.spot.Spot(
            ...
            longitude = 126.886514,
            tags = listOf(
                com.acon.acon.core.model.type.TagType.TOP_3,
                com.acon.acon.core.model.type.TagType.NEW,
                com.acon.acon.core.model.type.TagType.LOCAL
            ),
            closingTime = "22:00".toLocalTime()!!,
    ...
    selectedSpotType = com.acon.acon.core.model.type.SpotType.CAFE,
    currentLocation = Location(""),
)