package com.acon.acon.feature.spot.screen.spotlist.composable.bottomsheet
...
import com.acon.acon.core.designsystem.component.slider.AconSlider
...
fun ColumnScope.CafeBottomSheetContent(
    ...
    AconChipFlowRow(
        ...
        selectedChipIndices = selectedCafeFeatures.map { it.ordinal }.toImmutableList(),
        onChipSelected = {
    ...
    AconChipFlowRow(
        ...
        selectedChipIndices = selectedVisitPurposes.map { it.ordinal }.toImmutableList(),
        onChipSelected = {
