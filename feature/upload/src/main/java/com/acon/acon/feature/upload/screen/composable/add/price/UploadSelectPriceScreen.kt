    ...
    Column(
        ...
        Column(
            ...
            UploadPlaceSelectItem(
                title = stringResource(R.string.upload_place_select_price_option_1),
                isSelected = true
            )
            UploadPlaceSelectItem(
                title = stringResource(R.string.upload_place_select_price_option_2)
            )
            UploadPlaceSelectItem(
                title = stringResource(R.string.upload_place_select_price_option_3)
            )
        }
    }
}
